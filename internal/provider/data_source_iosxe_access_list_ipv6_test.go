...
func TestAccDataSourceIosxeAccessListIPv6(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxe_access_list_ipv6.test", "entries.0.destination_any", "true"))
	resource.Test(t, resource.TestCase{
		PreCheck:                 func() { testAccPreCheck(t) },
		ProtoV6ProviderFactories: testAccProtoV6ProviderFactories,
		Steps: []resource.TestStep{
			{
				Config: testAccDataSourceIosxeAccessListIPv6Config(),
...
func testAccDataSourceIosxeAccessListIPv6Config() string {
	...
	config += `
		data "iosxe_access_list_ipv6" "test" {
			name = "V6ACL1"
			depends_on = [iosxe_access_list_ipv6.test]
		}
	`
	return config
}
