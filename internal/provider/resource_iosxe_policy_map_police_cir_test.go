...
func TestAccIosxePolicyMapPoliceCirExceedTransmit(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccIosxePolicyMapPoliceCirExceedTransmitConfig(),
...
func testAccIosxePolicyMapPoliceCirExceedTransmitConfig() string {
	return `resource "iosxe_yang" "policy_class_map" {
      ...
      actions = [
        {
          ...
          police_bc = 312500
          police_cir_conform_transmit = true
          police_cir_exceed_transmit = true
        },
      ]
    },
  ]
